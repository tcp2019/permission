...
<script type="text/javascript">
    $(function () {
        ...
        function recursivePrepareTreeData(aclModuleList) {
            ...
            if (aclModuleList && aclModuleList.length > 0) {
                $(aclModuleList).each(function (i, aclModule) {
                    ...
                    if (aclModule.sysAclDtoList && aclModule.sysAclDtoList.length > 0) {
                        $(aclModule.sysAclDtoList).each(function (i, acl) {
                            zTreeObj.push({
                                id: aclPrefix + acl.id,
                    ...
                    if ((aclModule.aclModuleLevelDtoList && aclModule.aclModuleLevelDtoList.length > 0) ||
                        (aclModule.sysAclDtoList && aclModule.sysAclDtoList.length > 0)) {
        ...
        $(".saveRoleAcl").click(function (e) {
            ...
            $.ajax({
                url: "/sys/role/changeRoleAcl.json",
                data: {
                    roleId: lastRoleId,
